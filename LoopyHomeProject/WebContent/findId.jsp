	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form class="validation-form" novalidate method="post" action="./findId.do">

					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="custName">이름</label> 
							<input type="text" class="form-control" placeholder="이름을 입력해주세요." name="custName" id="inputId" required>
					...
					<div class="mb-4"></div>
					<button class="btn btn-primary btn-lg btn-block" type="submit" id="findId">아이디 찾기</button>
