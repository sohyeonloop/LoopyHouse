...
if (request.getParameter("check") == null || request.getParameter("check").equals("")) {
	listP = (ArrayList<ProductVO>) prodDao.selectCateProd("CE001");
} else if (request.getParameter("check").equals("total")) {
	listP = (ArrayList<ProductVO>) prodDao.selectCateProd("CE001");
} else if (request.getParameter("check").equals("sale")) {
	listP = (ArrayList<ProductVO>) prodDao.selectSaleProd("CE001");
} else if (request.getParameter("check").equals("wish")) {
	listP = (ArrayList<ProductVO>) prodDao.selectWishProd("CE001");
}
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<li class="total-prod"><a class="dropdown-item "
					href="${pageContext.request.contextPath}/digital.jsp?check=total">전체</a></li>
				<li><hr class="dropdown-divider"></li>
				<li class="sale-prod"><a class="dropdown-item"
					href="${pageContext.request.contextPath}/digital.jsp?check=sale">판매순</a></li>
				<li><hr class="dropdown-divider"></li>
				<li class="sale-prod"><a class="dropdown-item"
					href="${pageContext.request.contextPath}/digital.jsp?check=wish">위시리스트순</a></li>
			</ul>
		</div>
