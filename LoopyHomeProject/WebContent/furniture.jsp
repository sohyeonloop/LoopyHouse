...
if (request.getParameter("check") == null || request.getParameter("check").equals("")) {
	listP = (ArrayList<ProductVO>) prodDao.selectCateProd("F001");
} else if (request.getParameter("check").equals("total")) {
	listP = (ArrayList<ProductVO>) prodDao.selectCateProd("F001");
} else if (request.getParameter("check").equals("sale")) {
	listP = (ArrayList<ProductVO>) prodDao.selectSaleProd("F001");
} else if (request.getParameter("check").equals("wish")) {
	listP = (ArrayList<ProductVO>) prodDao.selectWishProd("F001");
}
...
<body>
		...
		<div class="btn-group">
			...
			<ul class="dropdown-menu">
				<li class="total-prod"><a class="dropdown-item "
					href="${pageContext.request.contextPath}/furniture.jsp?check=total">전체</a></li>
				<li><hr class="dropdown-divider"></li>
				<li class="sale-prod"><a class="dropdown-item"
					href="${pageContext.request.contextPath}/furniture.jsp?check=sale">판매순</a></li>
				<li><hr class="dropdown-divider"></li>
				<li class="sale-prod"><a class="dropdown-item"
					href="${pageContext.request.contextPath}/furniture.jsp?check=wish">위시리스트순</a></li>
			</ul>
		</div>
	...
	<div class=container>
		<div class="row" align="center">
			...
			<div class="col-md-4 output-prod">

				<img src="./images/<%=pv.getProdImage()%>" class="img">
				<!-- 상품이미지 경로! -->
				<h4><%=pv.getProdName()%></h4>
				<p><%=String.valueOf(pv.getProdPrice())%>원
				</p>
