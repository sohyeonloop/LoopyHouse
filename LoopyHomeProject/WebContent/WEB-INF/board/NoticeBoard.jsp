		...
		<div class="col-sm-12 text-center">
			...
			<div id="pageArea">
				...
				<ul class="pager">
					...
					%>
					<li><a
						href="${pageContext.request.contextPath}/comm/notice.do?page=<%=((int) request.getAttribute("cPage")) -1 %>">이전</a></li>
					<%
						} else if ((int) request.getAttribute("cPage") == 1) {
					%>
					<li><a
						href="${pageContext.request.contextPath}/comm/notice.do">이전</a></li>
					<%
						}
					%>
				</ul>
				...
				<ul class="pager">
					...
					%>
					<li><a
						href="${pageContext.request.contextPath}/comm/notice.do?page=<%=((int) request.getAttribute("cPage")) +1 %>">다음</a></li>
					<%
						} else if ((int) request.getAttribute("ePage") == 1) {
					%>
					<li><a
						href="${pageContext.request.contextPath}/comm/notice.do">다음</a></li>
					<%
						}
					%>
				</ul>
		...
		$('.pagination li')
				.on(
						...
						function() {
							//alert($(this).text());
							//Main서블릿으로 페이지정보 전달
							location.href = "${pageContext.request.contextPath}/comm/notice.do?page="
									+ $(this).text();
						});
